...
public class GradingSystem {
	// Method to generate random 2-digit scores for Physics, Chemistry, and Math
        ...
        for (int i = 0; i < numberOfStudents; i++) {
            for (int j = 0; j < 3; j++) {
                scores[i][j] = random.nextInt(100) + 1; // Random score between 1 and 100
            }
        }
        return scores;
    }
    ...
    public static void displayScore(int[][] scores, double[][] results, String[][] grades) {
	...
	//creating the instance of Scanner class
        ...
        displayScore(scores, results, grades);
    }
